...
import { buildSearchStatus, buildTabManager, buildCategoryFacet, buildFacetConditionsManager } from '@coveo/headless';
...
import { A as AriaLiveRegion, F as FocusTargetController } from './stencil-accessibility-utils.js';
import { C as CategoryFacetTreeValueContainer, a as CategoryFacetAllCategoryButton, b as CategoryFacetParentAsTreeContainer, c as CategoryFacetParentButton, d as CategoryFacetParentValueLink, e as CategoryFacetChildrenAsTreeContainer, f as CategoryFacetChildValueLink, g as CategoryFacetSearchResultsContainer, h as CategoryFacetSearchValue } from './value-as-tree-container.js';
...
const AtomicCategoryFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCategoryFacet extends HTMLElement {
    ...
    renderValuesTree(valuesAsTrees, isRoot) {
        if (!this.hasParents) {
        ...
        if (valuesAsTrees.length > 1) {
            ...
            return (h(CategoryFacetTreeValueContainer, null, h(CategoryFacetParentButton, { facetValue: parentValue, field: this.field, i18n: this.bindings.i18n, onClick: () => {
                ...
                } }), h(CategoryFacetParentAsTreeContainer, { isTopLevel: false }, this.renderValuesTree(valuesAsTrees.slice(1), false))));
        }
    ...
    renderChildren() {
        ...
        if (this.facetState.selectedValueAncestry.length > 0) {
            return this.facetState.selectedValueAncestry
                ...
                ?.children.map((value, i) => this.renderChild(value, i === 0, i === this.resultIndexToFocusOnShowMore));
        }
    ...
    renderMatches() {
        return (h(FacetSearchMatches, { i18n: this.bindings.i18n, query: this.facetState.facetSearch.query, numberOfMatches: this.facetState.facetSearch.values.length, hasMoreMatches: this.facetState.facetSearch.moreValuesAvailable, showMoreMatches: () => this.facet.facetSearch.showMoreResults() }));
    }
    renderShowMoreLess() {
    ...
    render() {
        ...
        return (h(FacetGuard, { key: '2a4a8636f34eacafadba610823ef41092ac7b054', enabled: enabled, firstSearchExecuted: firstSearchExecuted, hasError: hasError, hasResults: valuesAsTrees.length > 0 }, firstSearchExecuted ? (h(FacetContainer, null, this.renderHeader(), !this.isCollapsed && [
...
], AtomicCategoryFacet$1.prototype, "tabManagerState", void 0);
__decorate([
    ArrayProp()
], AtomicCategoryFacet$1.prototype, "tabsIncluded", void 0);
__decorate([
    ArrayProp()
], AtomicCategoryFacet$1.prototype, "tabsExcluded", void 0);
__decorate([
    ArrayProp()
...
function defineCustomElement$1() {
    ...
    const components = ["atomic-category-facet"];
