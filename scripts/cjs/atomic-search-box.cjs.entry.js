...
const AtomicSearchBox = class {
    ...
    initializeSearchboxController() {
        this.searchBox = this.redirectionUrl
            ? headless.buildStandaloneSearchBox(this.bindings.engine, {
                options: {
            ...
            : headless.buildSearchBox(this.bindings.engine, {
    ...
    renderSuggestions() {
        return (index.h("div", { id: `${this.id}-popup`, part: `suggestions-wrapper ${this.suggestionManager.isDoubleList
                ...
                : 'suggestions-single-list'}`, class: `bg-background border-neutral absolute top-full left-0 z-10 flex w-full rounded-md border ${this.shouldShowSuggestions ? '' : 'hidden'}`, role: "application", "aria-label": this.bindings.i18n.t(this.suggestionManager.isDoubleList
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'db08501e03347ae78ce04c3c820b2e9071179474' }, this.renderAbsolutePositionSpacer(), [
            index.h(stencilSuggestionManager.SearchBoxWrapper, { key: '79ab2d8624424cb59e3df81e9df87857a9062d73', disabled: isDisabled, onFocusout: (event) => {
                    if (!utils.isFocusingOut(event)) {
                        return;
                    }
                    this.suggestionManager.clearSuggestions();
                    this.isExpanded = false;
                } }, this.renderTextBox(searchLabel), index.h(stencilSubmitButton.SubmitButton, { key: 'd1129c427e3438e26ef3d7cc020c7605edbe39f3', bindings: this.bindings, disabled: isDisabled, onClick: () => {
                    this.searchBox.submit();
                    this.suggestionManager.clearSuggestions();
                }, title: searchLabel }), this.renderSuggestions()),
            !this.suggestionManager.suggestions.length && (index.h("slot", { key: '663a2b3c16ed7f9677ed0c62c753388b12a558af' }, index.h("atomic-search-box-recent-queries", { key: '349696d779a9bbd299a2ceec9f487fbb5324d305' }), index.h("atomic-search-box-query-suggestions", { key: 'b4cb87d93c86c523b56b594a6113a7fd05e934ed' }))),
        ]));
    }
