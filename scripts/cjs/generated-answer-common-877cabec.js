...
const GeneratedMarkdownContent = (props) => {
    const answerAsHtml = purify.DOMPurify.sanitize(transformMarkdownToHtml(props.answer ?? ''), { ADD_ATTR: ['part'] });
...
const ShowButton = (props) => (index.h(stencilButton.Button, { style: "text-primary", part: "answer-show-button", class: "hidden items-center hover:bg-transparent", onClick: () => props.onClick() },
    ...
    index.h("atomic-icon", { part: "answer-show-icon", class: "ml-2 w-3.5", icon: props.isCollapsed ? arrowBottomRounded.ArrowBottomIcon : arrowTopRounded.ArrowUp })));
...
class GeneratedAnswerCommon {
    ...
    get hasCustomNoAnswerMessage() {
        const slot = slotUtils.getNamedSlotFromHost(this.props.host, 'no-answer-message');
        return !!slot;
    }
    ...
    render() {
        ...
        if (this.hasNoAnswerGenerated) {
            return cannotAnswer && this.hasCustomNoAnswerMessage ? (index.h("div", null,
                index.h("aside", { class: contentClasses, part: "container" },
...
//# sourceMappingURL=generated-answer-common-877cabec.js.map