...
const iconButton = require('./iconButton-c1cd4b3f.js');
...
const QuickviewSidebar = (props) => {
    ...
    return (index.h("div", { class: "border-neutral h-full border-r p-4" },
...
const HighlightKeywordsCheckbox = ({ i18n, highlightKeywords, onHighlightKeywords, minimized }) => (index.h(index.Fragment, null,
    index.h(stencilCheckbox.StencilCheckbox, { text: i18n.t('keywords-highlight'), class: "mr-2", id: "atomic-quickview-sidebar-highlight-keywords", checked: !highlightKeywords.highlightNone, onToggle: (checked) => onHighlightKeywords({
            ...highlightKeywords,
            highlightNone: !checked,
        }) }),
    !minimized && (index.h("label", { class: "cursor-pointer font-bold whitespace-nowrap", htmlFor: "atomic-quickview-sidebar-highlight-keywords" }, i18n.t('keywords-highlight')))));
const Keywords = ({ words, i18n, highlightKeywords, onHighlightKeywords }) => {
    return (index.h("div", { id: identifierKeywordsSection }, Object.values(words).map((keyword) => {
        ...
        return (index.h("div", { key: keyword.text, class: "my-4 flex w-100 items-center justify-between gap-x-2" },
            index.h("div", { class: `bg-background border-neutral flex grow items-center overflow-x-auto rounded-lg border ${!wordIsEnabled ? 'pointer-events-none opacity-50' : ''}` },
                index.h("div", { class: "flex grow items-center border-r p-4", "aria-hidden": "true" },
                    index.h("div", { class: "mr-2 h-5 w-5 flex-none", style: { backgroundColor: keyword.color } }),
                    index.h("div", { class: "mr-2 grow whitespace-nowrap" }, keyword.text),
                    index.h("div", { class: "flex-none" },
                        ...
                        ")")),
                index.h(stencilFieldsetGroup.FieldsetGroup, { label: i18n.t('quickview-navigate-keywords', {
...
const QuickviewIframe = ({ onSetIframeRef, uniqueIdentifier, content, sandbox, src, logger }) => {
    ...
    return (index.h("iframe", { src: "about:blank", class: "h-full w-full", sandbox: sandbox, ref: async (el) => {
            const iframeRef = el;
...
const AtomicQuickviewModal = class {
    ...
    renderFooter() {
        return (index.h("div", { slot: "footer", class: "flex items-center gap-2" }, index.h(stencilButton.Button, { class: "p-2", style: "square-neutral", onClick: () => this.previousQuickview?.emit(), disabled: this.current === 1, text: this.bindings.i18n.t('quickview-previous') }), index.h("p", { class: "text-center" }, this.bindings.i18n.t('showing-results-of', {
            first: this.current,
            total: this.total,
        })), index.h(stencilButton.Button, { class: "p-2", style: "square-neutral", onClick: () => this.nextQuickview?.emit(), disabled: this.current === this.total, text: this.bindings.i18n.t('quickview-next') })));
    }
    onClose() {
        this.content = undefined;
        this.result = undefined;
    ...
    render() {
        return (index.h("atomic-modal", { key: 'e4b5c0ea75ce8a8d793182da65eee47b755dc514', fullscreen: this.bindings.store.isMobile(), class: 'atomic-quickview-modal', isOpen: this.isOpen, close: () => this.onClose() }, this.renderHeader(), this.renderBody(), this.renderFooter()));
    }
