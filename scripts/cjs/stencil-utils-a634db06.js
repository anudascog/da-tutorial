...
const QuerySummaryGuard = ({ hasResults, hasError, firstSearchExecuted }, children) => {
    ...
    if (!firstSearchExecuted) {
        return (index.h("div", { part: "placeholder", "aria-hidden": "true", class: "bg-neutral my-2 h-6 w-60 animate-pulse rounded" }));
    }
...
exports.getProductQuerySummaryI18nParameters = getProductQuerySummaryI18nParameters;
exports.getQuerySummaryI18nParameters = getQuerySummaryI18nParameters;

//# sourceMappingURL=stencil-utils-a634db06.js.map