...
function parseDate(date, format) {
    ...
    if (!parsedDate.isValid() && !format) {
        return dayjs_min.dayjs(date, headless.API_DATE_FORMAT);
    }
    return parsedDate;
}
/**
...
exports.parseTimestampToDateDetails = parseTimestampToDateDetails;

//# sourceMappingURL=date-utils-ee316e1d.js.map