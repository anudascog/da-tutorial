...
const StencilCheckbox = (props) => {
    ...
    return (index.h("button", { ...attributes, role: "checkbox", onClick: () => props.onToggle?.(!props.checked), onMouseDown: (e) => props.onMouseDown?.(e) },
        index.h("atomic-icon", { style: { stroke: 'white' }, class: `w-3/5 ${props.checked ? 'block' : 'hidden'}`, icon: Tick, part: props.iconPart })));
};

exports.StencilCheckbox = StencilCheckbox;
exports.Tick = Tick;

//# sourceMappingURL=stencil-checkbox-81c51bbd.js.map