...
const dependsOn = require('./depends-on-0d4e4f15.js');
const facetPlaceholder = require('./facet-placeholder-ad0407f0.js');
const stencilFacetShowMoreLess = require('./stencil-facet-show-more-less-8d757b5d.js');
const stencilFacetValueLabelHighlight = require('./stencil-facet-value-label-highlight-c2421e8f.js');
const stencilFacetSearchMatches = require('./stencil-facet-search-matches-6eb982ff.js');
...
require('./stencil-heading-2faee1f7.js');
...
const AtomicColorFacet = class {
    constructor(hostRef) {
        ...
        this.tabManagerState = undefined;
    ...
    initialize() {
        ...
        this.facet = headless.buildFacet(this.bindings.engine, { options: this.facetOptions });
        this.tabManager = headless.buildTabManager(this.bindings.engine);
        stencilFacetShowMoreLess.announceFacetSearchResultsWithAriaLive(this.facet, this.label, (msg) => (this.facetSearchAriaMessage = msg), this.bindings.i18n);
    ...
    get focusTargets() {
        if (!this.showLessFocus) {
            this.showLessFocus = new stencilAccessibilityUtils.FocusTargetController(this);
        }
        if (!this.showMoreFocus) {
            this.showMoreFocus = new stencilAccessibilityUtils.FocusTargetController(this);
        }
        if (!this.headerFocus) {
            this.headerFocus = new stencilAccessibilityUtils.FocusTargetController(this);
        }
        return {
    ...
    componentShouldUpdate(next, prev, propName) {
        if (propName === 'facetState' && prev && this.withSearch) {
            return stencilFacetValueLabelHighlight.shouldUpdateFacetSearchComponent(next.facetSearch, prev.facetSearch);
        }
        return true;
    }
    ...
    renderSearchInput() {
        ...
        return (index.h(stencilFacetSearchMatches.FacetSearchInput, { i18n: this.bindings.i18n, label: this.label, query: this.facetState.facetSearch.query, onChange: (value) => {
                if (value === '') {
        ...
        switch (this.displayValuesAs) {
            case 'checkbox':
                return (index.h(ColorFacetCheckbox, { displayValue: displayValue, numberOfResults: facetValue.numberOfResults, isSelected: isSelected, i18n: this.bindings.i18n, onClick: onClick, searchQuery: this.facetState.facetSearch.query, buttonRef: (element) => {
                    ...
                    } }, index.h(stencilFacetValueLabelHighlight.FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, searchQuery: this.facetState.facetSearch.query })));
            case 'box':
                return (index.h(stencilFacetValueBox.FacetValueBox, { displayValue: displayValue, numberOfResults: facetValue.numberOfResults, isSelected: isSelected, i18n: this.bindings.i18n, onClick: onClick, searchQuery: this.facetState.facetSearch.query, buttonRef: (element) => {
                        isShowLessFocusTarget &&
                            this.focusTargets.showLessFocus.setTarget(element);
                        isShowMoreFocusTarget &&
                            this.focusTargets.showMoreFocus.setTarget(element);
                    } }, index.h("div", { part: `value-${partValueWithDisplayValue} value-${partValueWithAPIValue} default-color-value`, class: "value-box-color bg-neutral-dark mb-2 h-12 w-full rounded-md" }), index.h(stencilFacetValueLabelHighlight.FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, isExcluded: isExcluded, searchQuery: this.facetState.facetSearch.query })));
        }
    }
    renderValuesContainer(children, query) {
        const classes = `mt-3 ${this.displayValuesAs === 'box' ? 'box-color-container' : ''}`;
        return (index.h(stencilFacetValuesGroup.FacetValuesGroup, { i18n: this.bindings.i18n, label: this.label, query: query }, index.h("ul", { class: classes, part: "values" }, children)));
    }
    renderValues() {
    ...
    renderMatches() {
        return (index.h(stencilFacetSearchMatches.FacetSearchMatches, { i18n: this.bindings.i18n, query: this.facetState.facetSearch.query, numberOfMatches: this.facetState.facetSearch.values.length, hasMoreMatches: this.facetState.facetSearch.moreValuesAvailable, showMoreMatches: () => this.facet.facetSearch.showMoreResults() }));
    }
    renderShowMoreLess() {
        return (index.h(stencilFacetShowMoreLess.FacetShowMoreLess, { label: this.label, i18n: this.bindings.i18n, onShowMore: () => {
    ...
    render() {
        ...
        return (index.h(facetPlaceholder.FacetContainer, null, this.renderHeader(), !this.isCollapsed && [
            ...
            stencilFacetValueLabelHighlight.shouldDisplaySearchResults(this.facetState.facetSearch)
...
__decorate([
    initializationUtils.BindStateToController('tabManager')
], AtomicColorFacet.prototype, "tabManagerState", void 0);
__decorate([
    propsUtils.ArrayProp()
], AtomicColorFacet.prototype, "tabsIncluded", void 0);
__decorate([
    propsUtils.ArrayProp()
], AtomicColorFacet.prototype, "tabsExcluded", void 0);
__decorate([
    propsUtils.MapProp()
...
__decorate([
    stencilAccessibilityUtils.AriaLiveRegion('facet-search')
