...
class TimeframeFacetCommon {
    ...
    get shouldRenderInput() {
        return stencilFacetCommon.shouldDisplayInputForFacetRange({
    ...
    renderValue(facetValue) {
        ...
        return (index.h(stencilFacetValueLink.FacetValueLink, { displayValue: displayValue, isSelected: isSelected, numberOfResults: facetValue.numberOfResults, i18n: this.props.bindings.i18n, onClick: () => this.facetForDateRange.toggleSingleSelect(facetValue) },
            index.h(stencilFacetValueLabelHighlight.FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, isExcluded: isExcluded })));
    }
    renderValuesContainer(children) {
        return (index.h(stencilFacetValuesGroup.FacetValuesGroup, { i18n: this.props.bindings.i18n, label: this.props.label },
    ...
    renderDateInput() {
        return (index.h("atomic-facet-date-input", { min: this.props.min, max: this.props.max, bindings: this.props.bindings, label: this.props.label, facetId: this.filter.state.facetId, rangeGetter: () => this.filter.state.range, rangeSetter: (request) => {
...
//# sourceMappingURL=timeframe-facet-common-29c8e27b.js.map