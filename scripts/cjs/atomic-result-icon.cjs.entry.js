...
const AtomicResultIcon = class {
    ...
    get icon() {
        const fileTypeValue = headless.ResultTemplatesHelpers.getResultProperty(this.result, 'filetype');
        const objectTypeValue = headless.ResultTemplatesHelpers.getResultProperty(this.result, 'objecttype');
