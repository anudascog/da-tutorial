...
const stencilSubmitButton = require('./stencil-submit-button-5f9bbeb4.js');
...
const AtomicCommerceSearchBox = class {
    constructor(hostRef) {
        ...
        this.renderTextBox = (searchLabel) => {
            ...
            return (index.h(stencilSuggestionManager.SearchTextArea, { textAreaRef: this.textAreaRef, ref: (el) => (this.textAreaRef = el), ...props, onClear: () => {
                    props.onClear();
    ...
    isStandaloneSearchBox(searchBox) {
    ...
    registerNewSearchBoxController() {
        this.disconnectedCallback();
        this.initialize();
    }
    initializeSearchboxController() {
        this.searchBox = this.redirectionUrl
            ? commerce.buildStandaloneSearchBox(this.bindings.engine, {
                options: {
            ...
            : commerce.buildSearchBox(this.bindings.engine, {
    ...
    registerSearchboxSuggestionEvents() {
    ...
    initializeSuggestionManager() {
        ...
        this.suggestionManager = new stencilSuggestionManager.SuggestionManager({
    ...
    get suggestionBindings() {
        return utils.spreadProperties(this.bindings, this.suggestionManager.partialSuggestionBindings, this.partialSuggestionBindings);
    }
    get partialSuggestionBindings() {
        return Object.defineProperties({ ...this.bindings }, {
            id: {
                get: () => this.id,
                enumerable: true,
            },
    ...
    renderSuggestion(item, index$1, lastIndex, side) {
        ...
        return (index.h("atomic-suggestion-renderer", { i18n: this.bindings.i18n, id: id, suggestion: item, isSelected: isSelected, side: side, index: index$1, lastIndex: lastIndex, isDoubleList: this.suggestionManager.isDoubleList, onClick: (e) => {
    ...
    renderPanel(side, elements, setRef, getRef) {
        ...
        return (index.h("div", { part: `suggestions suggestions-${side}`, ref: setRef, class: "flex grow basis-1/2 flex-col", onMouseDown: (e) => {
                if (e.target === getRef()) {
                    e.preventDefault();
                }
    ...
    renderSuggestions() {
        ...
        return (index.h("div", { id: `${this.id}-popup`, part: `suggestions-wrapper ${this.suggestionManager.isDoubleList
                ...
                : 'suggestions-single-list'}`, class: `bg-background border-neutral absolute top-full left-0 z-10 flex w-full rounded-md border ${this.suggestionManager.hasSuggestions &&
                this.isExpanded &&
    ...
    renderAbsolutePositionSpacer() {
        return (index.h("textarea", { "aria-hidden": true, part: "textarea-spacer", class: "invisible w-full px-4 py-3.5 text-lg", rows: 1 }));
    }
    isSearchDisabledForEndUser(queryValue) {
        if (bueno.isNullOrUndefined(queryValue)) {
    ...
    announceNewSuggestionsToScreenReader() {
        ...
        this.searchBoxAriaMessage = elsLength
            ? this.bindings.i18n.t(this.searchBoxState.value
    ...
    updateQueryWithoutQuerySuggestionTrigger(query) {
        const { engine } = this.bindings;
        engine.dispatch(commerce.loadQuerySetActions(engine).updateQuerySetQuery({
            id: this.id,
            query,
        }));
    }
    render() {
        ...
        const Submit = stencilSubmitButton.SubmitButton;
        ...
        return (index.h(index.Host, { key: '14bd4f57331c3b95805520e86614d4552c53c292' }, this.renderAbsolutePositionSpacer(), [
            index.h(stencilSuggestionManager.SearchBoxWrapper, { key: '26e67ca5d357904cf6c1b03e2132d637b70a434e', disabled: isDisabled, onFocusout: (event) => {
                    if (!utils.isFocusingOut(event)) {
                        return;
                    }
                    this.suggestionManager.clearSuggestions();
                    this.isExpanded = false;
                } }, this.renderTextBox(searchLabel), index.h(Submit, { key: 'bdf616fa3a0e768896e240dc27497b73f130ce9a', bindings: this.bindings, disabled: isDisabled, onClick: () => {
                    this.searchBox.submit();
                    this.suggestionManager.clearSuggestions();
                }, title: searchLabel }), this.renderSuggestions()),
            !this.suggestionManager.suggestions.length && (index.h("slot", { key: 'e9396bc6335eb2c8f9f563ae41f838d566d21b36' }, index.h("atomic-commerce-search-box-recent-queries", { key: '646dd6d319311fcf0548b6ac7ec86d8acd9f834a' }), index.h("atomic-commerce-search-box-query-suggestions", { key: '8408d137ad14117dbfbc63378c96a860c3ff429f' }))),
        ]));
    }
...
__decorate([
    stencilAccessibilityUtils.AriaLiveRegion('search-box')
], AtomicCommerceSearchBox.prototype, "searchBoxAriaMessage", void 0);
__decorate([
    stencilAccessibilityUtils.AriaLiveRegion('search-suggestions', true)
