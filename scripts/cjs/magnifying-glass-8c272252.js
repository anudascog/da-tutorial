...
const NoItemsContainer = (_, children) => [
    index.h("div", { class: "text-on-background flex h-full w-full flex-col items-center" }, children),
    index.h("slot", null),
];
...
const MagnifyingGlass = () => (index.h("atomic-icon", { part: "icon", icon: MagnifyingGlassIcon, class: "my-6 flex w-1/2 max-w-lg flex-col items-center" }));

exports.MagnifyingGlass = MagnifyingGlass;
exports.NoItemsContainer = NoItemsContainer;

//# sourceMappingURL=magnifying-glass-8c272252.js.map