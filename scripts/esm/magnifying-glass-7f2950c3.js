...
const NoItemsContainer = (_, children) => [
    h("div", { class: "text-on-background flex h-full w-full flex-col items-center" }, children),
    h("slot", null),
];
...
const MagnifyingGlass = () => (h("atomic-icon", { part: "icon", icon: MagnifyingGlassIcon, class: "my-6 flex w-1/2 max-w-lg flex-col items-center" }));

export { MagnifyingGlass as M, NoItemsContainer as N };

//# sourceMappingURL=magnifying-glass-7f2950c3.js.map