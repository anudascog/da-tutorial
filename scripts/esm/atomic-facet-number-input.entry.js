import { r as registerInstance, c as createEvent, h } from './index-3f35faca.js';
...
const FacetNumberInput = class {
    ...
    render() {
        ...
        return (h("form", { key: '319478ce87dcc7d73f145e7f4c3d8184bb5d7b57', class: "mt-4 gap-y-0.5 px-2", part: "input-form", onSubmit: (e) => {
                e.preventDefault();
                this.apply();
                return false;
            } }, h("label", { key: '3003be271098047ebcbe2817b8fedaf5477b35e1', part: "label-start", class: labelClasses, htmlFor: `${this.filterState.facetId}_start` }, minText), h("input", { key: '2a08a23efbbb364967a81b0dc65cc03cd74edc60', part: "input-start", id: `${this.filterState.facetId}_start`, type: "number", step: step, ref: (ref) => (this.startRef = ref), class: inputClasses, "aria-label": minAria, required: true, min: Number.MIN_SAFE_INTEGER, max: this.end, value: this.filterState.range?.start, onInput: (e) => (this.start = e.target.valueAsNumber) }), h("label", { key: '323807d6cd0b35143ae652a3aa8cf26efce61449', part: "label-end", class: labelClasses, htmlFor: `${this.filterState.facetId}_end` }, maxText), h("input", { key: '09de37085c18fc11e2b0271ef9713d9283a569e0', part: "input-end", id: `${this.filterState.facetId}_end`, type: "number", step: step, ref: (ref) => (this.endRef = ref), class: inputClasses, "aria-label": maxAria, required: true, min: this.start, max: Number.MAX_SAFE_INTEGER, value: this.filterState.range?.end, onInput: (e) => (this.end = e.target.valueAsNumber) }), h(Button, { key: '58c99c56e8c9d73605e9ab138fd09e0e21909d11', style: "outline-primary", type: "submit", part: "input-apply-button", class: "flex-none truncate p-2.5", ariaLabel: applyAria, text: apply })));
    }
};
