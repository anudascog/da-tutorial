import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-3f35faca.js';
import { isNullOrUndefined } from '@coveo/bueno';
import { buildStandaloneSearchBox, buildSearchBox, loadQuerySetActions } from '@coveo/headless/commerce';
...
import { A as AriaLiveRegion } from './stencil-accessibility-utils-08c682fb.js';
import { o as once, r as randomID, s as spreadProperties, b as isFocusingOut } from './utils-0a01e06c.js';
import { S as SearchTextArea, a as SuggestionManager, b as SearchBoxWrapper } from './stencil-suggestion-manager-2dadea7e.js';
import { S as SubmitButton } from './stencil-submit-button-4b6de96b.js';
import { e as elementHasQuery } from './suggestions-common-011266e4.js';
...
import './debounce-utils-efa015c0.js';
...
const AtomicCommerceSearchBox = class {
    ...
    get suggestionBindings() {
        return spreadProperties(this.bindings, this.suggestionManager.partialSuggestionBindings, this.partialSuggestionBindings);
    }
    ...
    renderSuggestion(item, index, lastIndex, side) {
        ...
        return (h("atomic-suggestion-renderer", { i18n: this.bindings.i18n, id: id, suggestion: item, isSelected: isSelected, side: side, index: index, lastIndex: lastIndex, isDoubleList: this.suggestionManager.isDoubleList, onClick: (e) => {
    ...
    renderPanel(side, elements, setRef, getRef) {
        ...
        return (h("div", { part: `suggestions suggestions-${side}`, ref: setRef, class: "flex grow basis-1/2 flex-col", onMouseDown: (e) => {
                if (e.target === getRef()) {
                    e.preventDefault();
                }
    ...
    renderAbsolutePositionSpacer() {
        return (h("textarea", { "aria-hidden": true, part: "textarea-spacer", class: "invisible w-full px-4 py-3.5 text-lg", rows: 1 }));
    }
    ...
    updateQueryWithoutQuerySuggestionTrigger(query) {
        ...
        engine.dispatch(loadQuerySetActions(engine).updateQuerySetQuery({
            id: this.id,
            query,
        }));
    }
    render() {
        ...
        return (h(Host, { key: '14bd4f57331c3b95805520e86614d4552c53c292' }, this.renderAbsolutePositionSpacer(), [
            h(SearchBoxWrapper, { key: '26e67ca5d357904cf6c1b03e2132d637b70a434e', disabled: isDisabled, onFocusout: (event) => {
                    if (!isFocusingOut(event)) {
                        return;
                    }
                    this.suggestionManager.clearSuggestions();
                    this.isExpanded = false;
                } }, this.renderTextBox(searchLabel), h(Submit, { key: 'bdf616fa3a0e768896e240dc27497b73f130ce9a', bindings: this.bindings, disabled: isDisabled, onClick: () => {
                    this.searchBox.submit();
                    this.suggestionManager.clearSuggestions();
                }, title: searchLabel }), this.renderSuggestions()),
            !this.suggestionManager.suggestions.length && (h("slot", { key: 'e9396bc6335eb2c8f9f563ae41f838d566d21b36' }, h("atomic-commerce-search-box-recent-queries", { key: '646dd6d319311fcf0548b6ac7ec86d8acd9f834a' }), h("atomic-commerce-search-box-query-suggestions", { key: '8408d137ad14117dbfbc63378c96a860c3ff429f' }))),
        ]));
    }
