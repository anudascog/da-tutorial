...
import { buildSearchStatus, buildFacet, buildTabManager, buildFacetConditionsManager } from '@coveo/headless';
import { a as getFieldCaptions, g as getFieldValueCaption } from './field-utils-f0146383.js';
import { I as InitializeBindings, B as BindStateToController, H as Hidden } from './initialization-utils-ff3edf9a.js';
import { A as ArrayProp, M as MapProp } from './props-utils-525cbc5b.js';
import { A as AriaLiveRegion, F as FocusTargetController } from './stencil-accessibility-utils-08c682fb.js';
import { p as parseDependsOn } from './depends-on-d73b0ce3.js';
import { F as FacetHeader, b as FacetPlaceholder, a as FacetContainer } from './facet-placeholder-1ed55384.js';
import { a as announceFacetSearchResultsWithAriaLive, F as FacetShowMoreLess } from './stencil-facet-show-more-less-cf037727.js';
import { s as shouldUpdateFacetSearchComponent, F as FacetValueLabelHighlight, a as shouldDisplaySearchResults } from './stencil-facet-value-label-highlight-b4083ffd.js';
import { F as FacetSearchInput, a as FacetSearchMatches } from './stencil-facet-search-matches-fb39731f.js';
...
import { i as initializePopover } from './popover-type-895c0e24.js';
...
import './stencil-heading-2b28a9b9.js';
        ...
        switch (this.displayValuesAs) {
            ...
            case 'box':
                return (h(FacetValueBox, { displayValue: displayValue, numberOfResults: facetValue.numberOfResults, isSelected: isSelected, i18n: this.bindings.i18n, onClick: onClick, searchQuery: this.facetState.facetSearch.query, buttonRef: (element) => {
                        ...
                        isShowMoreFocusTarget &&
                            this.focusTargets.showMoreFocus.setTarget(element);
                    } }, h("div", { part: `value-${partValueWithDisplayValue} value-${partValueWithAPIValue} default-color-value`, class: "value-box-color bg-neutral-dark mb-2 h-12 w-full rounded-md" }), h(FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, isExcluded: isExcluded, searchQuery: this.facetState.facetSearch.query })));
        }
    }
