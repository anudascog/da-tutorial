...
import { F as FieldValueIsNaNError } from './error-64f0ec13.js';
...
const Rating = (props) => {
    ...
    const renderIcon = (active) => {
        return (h("atomic-icon", { icon: props.icon, class: `shrink-0 ${active ? 'icon-active' : 'icon-inactive'}`, style: { width: iconSize, height: iconSize }, part: "value-rating-icon" }));
    };
    ...
    return (h("div", { class: "relative w-max", part: "value-rating", role: "img", "aria-label": props.i18n.t('stars', {
        ...
        h("div", { class: "absolute top-0 left-0 z-1 flex gap-0.5 overflow-hidden", style: { width } }, filledIconDisplay())));
};
...
//# sourceMappingURL=atomic-rating-6f3a61b9.js.map