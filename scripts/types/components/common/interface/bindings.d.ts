 ...
 */
export interface CommonBindings<Engine extends AnyEngineType, Store extends AnyStore, InterfaceElement extends HTMLElement> {
    /**
...
type AnyStore = CommerceStore | CommerceRecommendationStore | RecsStore | InsightStore | SearchStore;
export {};
