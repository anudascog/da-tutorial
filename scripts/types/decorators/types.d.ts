 ...
 */
export interface BaseInitializableComponent<SpecificBindings extends AnyBindings = AnyBindings, ReturnType = void> {
    /**
 ...
 */
export type InitializableComponent<SpecificBindings extends AnyBindings = AnyBindings> = BaseInitializableComponent<SpecificBindings, void>;
/**
 ...
 */
export type SearchBoxSuggestionsComponent<SpecificBindings extends AnyBindings = AnyBindings> = BaseInitializableComponent<SpecificBindings, SearchBoxSuggestions>;
